package com.mrwang.springboot.utils;
...
public class ServerUtil {
	 ...
	 */
	public static InetAddress getLocalHostLANAddress2() throws UnknownHostException {
	    try {
	        InetAddress candidateAddress = null;
	        // Iterate all NICs (network interface cards)...
	...
	public static InetAddress getLocalHostLANAddressBySocket() throws IOException {
	...
	public static InetAddress getLocalHostLANAddressByDatagramSocket() throws IOException {
